...
- [**Patient Manager**](https://github.com/nima-nourinejad/heath_census.) - Manages patient data and generates real-time statistics using HTML, CSS, JavaScript, and JSON. [You can check it here.](https://nima-nourinejad.github.io/memory-match-game/)
